...
const AMENITY_CONFIG: Record<string, { icon: string; key: string }> = {
    ...
    'Free WiFi': { icon: 'wifi', key: 'freeWifi' },
    'AC': { icon: 'snowflake-o', key: 'ac' },
    'Air Conditioning': { icon: 'snowflake-o', key: 'airConditioning' },
    'Parking': { icon: 'car', key: 'parking' },
    'Free Parking': { icon: 'car', key: 'freeParking' },
    'Pool': { icon: 'tint', key: 'pool' },
    'Swimming Pool': { icon: 'tint', key: 'swimmingPool' },
    'Gym': { icon: 'heartbeat', key: 'gym' },
    'Fitness Center': { icon: 'heartbeat', key: 'fitness' },
    'Restaurant': { icon: 'cutlery', key: 'restaurant' },
    'Rooftop Restaurant': { icon: 'cutlery', key: 'rooftopRestaurant' },
    ...
    'Free Breakfast': { icon: 'coffee', key: 'freeBreakfast' },
    'Bar': { icon: 'glass', key: 'bar' },
    'Business': { icon: 'briefcase', key: 'business' },
    'Business Center': { icon: 'briefcase', key: 'business' },
    'Sunning': { icon: 'sun-o', key: 'sunning' },
    'Beach Access': { icon: 'umbrella', key: 'beachAccess' },
    'Beach': { icon: 'umbrella', key: 'beach' },
    'Private Beach': { icon: 'umbrella', key: 'privateBeach' },
    'Balcony': { icon: 'home', key: 'balcony' },
    'Sea View': { icon: 'ship', key: 'seaView' },
    'Ocean View': { icon: 'ship', key: 'oceanView' },
    'City View': { icon: 'building', key: 'cityView' },
    'Rooftop': { icon: 'building-o', key: 'rooftop' },
    'Terrace': { icon: 'building-o', key: 'terrace' },
    'Garden': { icon: 'tree', key: 'garden' },
    'TV': { icon: 'tv', key: 'tv' },
    'Minibar': { icon: 'glass', key: 'minibar' },
    'Kitchen': { icon: 'cutlery', key: 'kitchen' },
    'Elevator': { icon: 'arrow-up', key: 'elevator' },
    'Lift': { icon: 'arrow-up', key: 'lift' },
    'Laundry': { icon: 'recycle', key: 'laundry' },
    '24/7 Security': { icon: 'shield', key: 'security' },
    '24/7 Reception': { icon: 'clock-o', key: 'reception' },
    'CCTV': { icon: 'video-camera', key: 'cctv' },
};
